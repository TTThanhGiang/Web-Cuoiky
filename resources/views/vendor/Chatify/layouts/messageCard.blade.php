...
<div class="message-card @if($isSender) mc-sender @endif" data-id="{{ $id }}">
    ...
    <div class="message-card-content">
        @if(isset($attachment) && $attachment->type != 'image' || $message)
            <div class="message">
                {!! ($message == null && isset($attachment) && $attachment->type != 'file') ? $attachment->title : nl2br($message) !!}
                {!! $timeAndSeen !!}

                {{-- If attachment is a file --}}
                @if(isset($attachment) && $attachment->type == 'file')
        ...
        @if(isset($attachment) && $attachment->type == 'image')
