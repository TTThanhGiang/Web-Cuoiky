  ...
  <div class="sidepanel-inner d-flex flex-column">
    ...
    <div class="app-branding">
      <a class="app-logo" href="index.html">
        <img class="" src="assets/web/img/logo.png" alt="logo" />
      </a>
    </div>
    <!--//app-branding-->
    <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
      <ul class="app-menu list-unstyled accordion" id="menu-accordion">
        ...
        <li class="nav-item has-submenu">
          ...
          >
          <!-- class=" ${'category' == view ? 'nav-link submenu-toggle active' : 'nav-link submenu-toggle'}" -->
            <span class="nav-icon">
              <svg
                width="1em"
                height="1em"
          ...
          <div
            id="submenu-0"
            class="collapse submenu submenu-0"
        ...
        <li class="nav-item has-submenu">
          ...
          >
          <!-- class="{'product' == view ? 'nav-link submenu-toggle active' : 'nav-link submenu-toggle'}" -->
            <span class="nav-icon">
              <svg
                width="1em"
                height="1em"
        ...
        <li class="nav-item has-submenu">
          ...
          >
            <ul class="submenu-list list-unstyled">
              <li class="submenu-item">
                <a
                  class="{{ $childView != null && $childView == 'management-blog' ? 'submenu-link active' : 'submenu-link'}}"
