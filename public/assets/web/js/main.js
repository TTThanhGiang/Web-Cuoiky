$(document).ready(function () {
    ...
    $(".active-banner-slider").owlCarousel({
        ...
        nav: true,
        navText: [
            "<img src='assets/web/img/banner/prev.png'>",
            "<img src='assets/web/img/banner/next.png'>",
        ],
        dots: false,
    });
    ...
    $(".active-product-area").owlCarousel({
        ...
        nav: true,
        navText: [
            "<img src='assets/web/img/product/prev.png'>",
            "<img src='assets/web/img/product/next.png'>",
        ],
        dots: false,
    });
